...
The legacy runners (``smoke.py``, ``yandex_service_test.py``,
``core_audio_test.py``) print every check and raise on the first failure; this
module exposes them as ordinary pytest tests so CI collects one report.
"""
